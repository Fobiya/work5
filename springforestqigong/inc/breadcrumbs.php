...
function dimox_breadcrumbs() {
	...
	$wrap_before    = '<div class="row"><div class="col m12 s12 l12 xl12"><div class="breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList"><ul>'; // открывающий тег обертки
	$wrap_after     = '</ul></div></div></div><!-- .breadcrumbs -->'; // закрывающий тег обертки
...
// dimox_breadcrumbs_notrow()

function dimox_breadcrumbs_notrow() {
