        ...
        <div class="row">
                ...
                <div class="block__tab"><a class="title __tab" href="javascript:;">Category</a>
                  <div class="box__select"> 
                    <div class="form_input"><span class="field">
                        <input class="name" type="checkbox" name="Advanced" required="" value="Advanced" placeholder="Advanced"></span></div>
                  </div>
                </div>
          ...
          <div class="col m12 s12 l8 xl8">
            ...
            <div class="block__post">
              <div class="post__">
                <div class="block__img"><img src="<?= get_template_directory_uri(); ?>/img/courses__1_post.png" alt="menu"></div>
                <div class="block__content">
                  <p class="catalog">Advanced</p>
                  <h4 class="title__post">Pellentesque leo and text continues here. More text here</h4>
